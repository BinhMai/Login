	...
	<div class="col-md-6" style="margin-left: 300px;margin-top: 150px; background-color: yellow">
		...
		<form action="showImf.php" method="post">
			<div class="col-md-12">
				...
				<input class="col-md-6" style="padding-left:0px; margin-top: 20px" type="text" name="acc">
			</div>
			<div class="col-md-12">
				<span class="col-md-4" style="padding-right:0px"><h3>Mật Khẩu:</h3></span>
				<input class="col-md-6" style="padding-left:0px; margin-top: 20px" type="text" name="pass">
			</div>
