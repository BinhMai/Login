...
<?php 
	...
	if(isset($_GET['user']))
		$data = $DB->get_listMyStatus('status','user_status',$_GET['user'],'order by date DESC, time DESC',$start,$limit);
	else
		$data = $DB->get_listMyStatus('status','user_status',$_COOKIE['acc'],'order by date DESC, time DESC',$start,$limit);
?>
